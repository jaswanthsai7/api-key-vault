...
import TableShimmer from "@/components/TableShimmer"; // ✅ Import dynamic shimmer
    ...
    <>
      ...
      <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm mb-6">
        <p className="font-medium text-gray-700 mb-2">
          API Requests (Past 7 Days)
        </p>

        {loading ? (
          <TableShimmer rows={1} columns={7} columnWidth="w-1/6" height="h-24" />
        ) : usageStats.length === 0 ? (
